<template>
  <BorderLayout title-name="网络安全运维">
    <template #context>
      <div class="px-[20px] left-box1">
        <div class="flex justify-between mb-[5px]">
          <div>
            <div><span class="text-[#1AF1E9]">核心成员：</span>唐小虎 徐杰</div>
          </div>
          <div class="text-[#1AF1E9]">当前排名：第<span class="text-[#FF9834]">1</span>名</div>
        </div>
        ...
        <div class="flex justify-between ">
          <div class="left-text-box ">
            ...
            <div>
              ...
              信息安全事件发生情况
              <div class="px-[20px]"><span class="text-[#1AF1E9] text-[20px]">100</span>起</div>
            </div>
          </div>
